...
class DegenerateTriangleTest(unittest.TestCase):
    def test_degenerate_triangle_is_not_equilateral(self):
        self.assertFalse(equilateral([1, 2, 3]))

    def test_degenerate_triangle_is_not_isoceles(self):
        self.assertFalse(isosceles([1, 2, 3]))

    def test_degenerate_triangle_is_not_scalene(self):
        self.assertFalse(scalene([2, 3, 5]))
